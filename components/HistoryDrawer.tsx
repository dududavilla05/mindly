              ...
              <div className="flex flex-col gap-2">
                ...
                {mindMapsLoading ? (
                  ...
                  <div className="flex flex-col items-center gap-2 mt-8 px-4 text-center">
                    <span className="text-2xl">🧠</span>
                    <p className="text-xs text-white/40 leading-relaxed">Crie seu primeiro mapa mental!</p>
                  </div>
                ) : (
                  mindMaps.map((item) => (
                    <div
              ...
              <div className="flex flex-col gap-2">
                ...
                {journeysLoading ? (
                  ...
                  <div className="flex flex-col items-center gap-2 mt-8 px-4 text-center">
                    ...
                    <p className="text-xs text-white/40 leading-relaxed">Inicie sua primeira jornada de aprendizado!</p>
                  </div>
                ) : (
                  journeys.map((item) => {
